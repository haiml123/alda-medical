...
#include "UI/screen_header.h"
#include "UI/tabbar/tabbar.h"
#include "admin_settings_model.h"
#include "imgui.h"
#include "views/channels_config/channels_config_model.h"
#include "views/channels_config/channels_config_presenter.h"
#include "views/channels_config/channels_config_view.h"
...
class AdminSettingsView
{
  public:
    ...
    elda::ui::DynamicForm& form()
    {
        return form_;
    }
    int get_active_tab() const
    {
        return tab_bar_.get_active_tab();
    }

    // Access to channels config for saving
    channels_config::ChannelsConfigModel& channels_model()
    {
        return channels_model_;
    }
    const channels_config::ChannelsConfigModel& channels_model() const
    {
        return channels_model_;
    }
