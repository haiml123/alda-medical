...
inline const char* signal_type_to_string(SignalType type)
{
    switch (type)
    {
        case SignalType::EEG:
            return "EEG";
        case SignalType::ECG_EMG:
            return "ECG/EMG";
        case SignalType::ICG_IMP:
            return "ICG/Imp";
        case SignalType::SCG_MOV:
            return "SCG/MOV";
        case SignalType::FPG_RESP:
            return "FPG/Resp";
        case SignalType::GSR:
            return "GSR";
        case SignalType::TEMP:
            return "Temp";
        case SignalType::ROT:
            return "ROT";
        case SignalType::BP:
...
inline const char* hpf_to_string(HPFOption hpf)
{
    switch (hpf)
    {
        case HPFOption::DC:
            return "DC";
        case HPFOption::HPF_0001:
            return "0.001 Hz";
        case HPFOption::HPF_001:
            return "0.01 Hz";
        case HPFOption::HPF_01:
            return "0.1 Hz";
        case HPFOption::HPF_1:
            return "1 Hz";
        default:
            return "DC";
    }
...
inline const char* lpf_to_string(LPFOption lpf)
{
    switch (lpf)
    {
        case LPFOption::NONE:
            return "None";
        case LPFOption::LPF_250:
            return "250 Hz";
        case LPFOption::LPF_500:
            return "500 Hz";
        default:
            return "None";
    }
...
inline const char* adf_to_string(ADFOption adf)
{
    switch (adf)
    {
        case ADFOption::OFF:
            return "Off";
        case ADFOption::ADF_50:
            return "50 Hz";
        case ADFOption::ADF_60:
            return "60 Hz";
        default:
            return "Off";
    }
  ...
  public:
    ...
    void init_default_channels(int count)
    {
        ...
        static const char* standard_names[] = {
            ...
            "P3",  "Pz",  "P4",  "T6",  "O1",  "Oz",  "O2",  "AF7", "AF3", "AFz", "AF4", "AF8", "F5",
            "F1",  "F2",  "F6",  "FC5", "FC1", "FC2", "FC6", "T7",  "C5",  "C1",  "C2",  "C6",  "T8",
            "CP5", "CP1", "CP2", "CP6", "P7",  "P5",  "P1",  "P2",  "P6",  "P8",  "PO7", "PO3", "POz",
            "PO4", "PO8", "Fpz", "CPz", "TP7", "TP8", "FT7", "FT8", "A1",  "A2",  "M1",  "M2"};
    ...
    const std::vector<ChannelConfig>& channels() const
    {
        return channels_;
    }
    ...
    void select_channel(int id, bool selected)
    {
        ...
        {
            selected_ids_.erase(std::remove(selected_ids_.begin(), selected_ids_.end(), id), selected_ids_.end());
        }
    }
