...
namespace elda::views::channels_config {
    ...
    public:
        ...
        void render(const std::vector<ChannelConfig>& channels,
                    const ChannelsConfigCallbacks& callbacks);

    private:
        void render_table(const std::vector<ChannelConfig>& channels,
                         const ChannelsConfigCallbacks& callbacks);
        void render_channel_row(const ChannelConfig& channel,
                               const ChannelsConfigCallbacks& callbacks);
    };
