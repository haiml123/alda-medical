...
public:
    ...
    // Data accessors
    NVXDeviceConfig& device_config() { return device_config_; }
    const NVXDeviceConfig& device_config() const { return device_config_; }

    OutputConfig& output_config() { return output_config_; }
    const OutputConfig& output_config() const { return output_config_; }

    ChannelDefaults& channel_defaults() { return channel_defaults_; }
    const ChannelDefaults& channel_defaults() const { return channel_defaults_; }
