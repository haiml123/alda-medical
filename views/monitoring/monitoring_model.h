...
namespace elda::views::monitoring {
    ...
    public:
        ...
        const ChartData& get_chart_data() const { return chart_data_; }

        bool is_monitoring() const { return state_manager_.is_monitoring();}

        bool can_record() const { return is_monitoring(); }

        bool is_recording_active() const {
            return state_manager_.is_recording_active() && state_manager_.is_monitoring();
        }

        RecordingState get_recording_state() const { return state_manager_.get_recording_state(); }
        ...
        bool is_stopped() const { return state_manager_.is_stopped(); }
        ...
        double get_sample_rate_hz() const { return SAMPLE_RATE_HZ; }
