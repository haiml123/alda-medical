...
class CapPlacementModel
{
  public:
    ...
    const std::vector<PlacementStep>& steps() const
    {
        return steps_;
    }
    ...
    const PlacementStep& current_step() const
    {
    ...
    {
        return current_step_index_ == 0;
    }
    bool is_last_step() const
    {
        return current_step_index_ == steps_.size() - 1;
    }
