...
class CapPlacementView
{
  public:
    ...
    void render(const CapPlacementViewData& data, const CapPlacementViewCallbacks& callbacks);

  private:
    void render_content(const CapPlacementViewData& data, const CapPlacementViewCallbacks& callbacks);
    void render_step_indicator(const CapPlacementViewData& data);
    void render_step_content(const CapPlacementViewData& data);
    void render_navigation(const CapPlacementViewData& data, const CapPlacementViewCallbacks& callbacks);
