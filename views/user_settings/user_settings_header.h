...
inline float render_user_settings_header(
    const UserSettingsHeaderData& data,
    ...
    ImGui::BeginChild("##UserSettingsHeader", ImVec2(0, header_h), false,
    ...
    ImVec4 txt_color = data.can_proceed
        ? ImVec4(1, 1, 1, 1)
        : ImVec4(0.5f, 0.52f, 0.55f, 1.0f);
