...
struct Tab
{
    ...
    explicit Tab(const std::string& label_) : label(label_), id(label_)
    {
    }

    Tab(const std::string& label_, int badge_) : label(label_), id(label_), badge(badge_)
    {
    }

    Tab(const std::string& label_, const std::string& id_) : label(label_), id(id_)
    {
    }
...
struct TabBounds
{
    ...
    TabBounds() = default;
    TabBounds(float x_, float y_, float w_, float h_) : x(x_), y(y_), width(w_), height(h_)
    {
    }
...
class TabBar
{
  public:
    ...
    const std::vector<TabBounds>& get_all_tab_bounds() const
    {
        return tab_bounds_;
    }
    ...
    void set_on_tab_click(TabClickCallback callback)
    {
        on_tab_click_ = callback;
    }
    void set_on_tab_hover(TabHoverCallback callback)
    {
        on_tab_hover_ = callback;
    }
    void set_on_tab_right_click(TabRightClickCallback callback)
    {
        on_tab_right_click_ = callback;
    }
    void set_on_tab_double_click(TabDoubleClickCallback callback)
    {
        on_tab_double_click_ = callback;
    }
    void set_on_add_tab(AddTabCallback callback)
    {
        on_add_tab_ = callback;
    }
